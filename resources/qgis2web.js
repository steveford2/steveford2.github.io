...
var map = new ol.Map({
    controls: ol.control.defaults({attribution:false}).extend([
        expandedAttribution,new ol.control.LayerSwitcher({tipLabel: "Layers"}),new geolocateControl()
    ]),
    ...
    layers: layersList,
    view: new ol.View({
        extent: [19327824.808926, -5105675.799898, 19392378.914295, -5062790.205422], maxZoom: 19, minZoom: 10
    })
});

map.getView().fit([19327824.808926, -5105675.799898, 19392378.914295, -5062790.205422], map.getSize());
